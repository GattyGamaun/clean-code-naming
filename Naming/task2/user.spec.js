...
describe('user', () => {
    describe('toString', () => {
        it('should print user', () => {
            ...
            assert.strictEqual(bob.getWholeUserDataInTheStringFormat(), 'User [dateOfBirth=14.02.1974, name=Bob, isAdmin=false, subordinates=[], rating=0]');
        });
        ...
        it('should print admin user with rating', () => {
            ...
            assert.strictEqual(bob.getWholeUserDataInTheStringFormat(), 'User [dateOfBirth=14.02.1974, name=Bob, isAdmin=true, subordinates=[], rating=33]');
        });
    });
});
